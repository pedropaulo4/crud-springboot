 ...
 */
	...
	public List<Pedido> getPedidos() {
		...
		//percorrendo os itens de pedidos, na lista de itens
		for(ItemPedido x : itens) {
			// pra cada item de pedido x que existe na minha lista de itens, eu adiciono o pedido associado a ele na minha lista
